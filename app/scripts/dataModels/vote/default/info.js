...
define(function(require, exports, module) {
	...
	function dataToModel(data) {
		...
		var booleans = DataFilter.booleans(["hideVotes", "repeatable", "compulsory", "permitAttentionComment", "permitComment", "compulsivelyBindPhoneNumber", "compulsivelyInWechat", "isHistory"], data);
	...
	function modelToData(model) {
		...
		$(["type", "name", "thumbnailUrl", "terse", "description", "hideVotes", "repeatable", "compulsory", "startDate", "endDate", "sortType", "permitComment", "permitAttentionComment", "compulsivelyBindPhoneNumber", "compulsivelyInWechat"]).each(function(idx, field) {
